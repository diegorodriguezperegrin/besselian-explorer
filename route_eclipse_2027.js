  ...
  "scenes": [
    {
      ...
      "camEnd":   { "lat": 36.0, "lng": -34.0, "radius": 72.0 },
      "targetStart": "moon",
      "targetEnd":   "shadow",
      "targetTurnEnd": 0.40,
    ...
    },
    {
      ...
      "desc": "Volamos a la estela de la umbra con el horizonte terrestre al frente: la totalidad cubre Tarifa, Cádiz y la costa andaluza a 2.500 km/h.",
      "camStart": { "lat": 36.0, "lng": -34.0, "radius": 72.0 },
      "camEnd":   { "lat": 35.0, "lng": -10.0, "radius": 66.0 },
      "targetStart": "shadow",
      "targetEnd":   "shadow",
    ...
    },
    {
      ...
      "desc": "Sobrevuelo rasante a velocidad constante sobre las dunas de Argelia y Libia, manteniendo el horizonte nivelado mientras la umbra corre veloz por el desierto.",
      "camStart": { "lat": 35.0, "lng": -10.0, "radius": 66.0 },
      "camEnd":   { "lat": 31.0, "lng": 9.0, "radius": 66.0 },
      "targetStart": "shadow",
      "targetEnd":   "shadow",
      "horizonBlendStart": 1.0,
      "horizonBlendEnd": 1.0,
    ...
    },
    {
      ...
      "camStart": { "lat": 31.0, "lng": 9.0, "radius": 66.0 },
      "camEnd":   { "lat": 26.0, "lng": 25.0, "radius": 70.0 },
      "targetStart": "shadow",
      "targetEnd":   "sun",
      "horizonBlendStart": 1.0,
      "horizonBlendEnd": 1.0,
    ...
    },
    {
      ...
      "camStart": { "lat": 26.0, "lng": 25.0, "radius": 70.0 },
