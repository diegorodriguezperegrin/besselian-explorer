  ...
  "scenes": [
    {
      ...
      "camEnd":   { "lat": 33.0, "lng": -26.0, "radius": 82.0 },
      "targetStart": "moon",
      "targetEnd":   "shadow",
      "targetTurnEnd": 0.40,
    ...
    },
    {
      ...
      "desc": "Seguimos la estela de la umbra desde la órbita baja con el horizonte terrestre al frente: la totalidad cubre Tarifa, Cádiz y la costa andaluza a 2.500 km/h.",
      "camStart": { "lat": 33.0, "lng": -26.0, "radius": 82.0 },
      "camEnd":   { "lat": 30.0, "lng": -4.0,  "radius": 75.0 },
      "targetStart": "shadow",
      "targetEnd":   "shadow",
    ...
    },
    {
      ...
      "desc": "Sobrevuelo orbital a velocidad constante sobre el desierto del Sahara, manteniendo el horizonte nivelado mientras la umbra corre veloz por el desierto.",
      "camStart": { "lat": 30.0, "lng": -4.0,  "radius": 75.0 },
      "camEnd":   { "lat": 26.0, "lng": 14.0,  "radius": 75.0 },
      "targetStart": "shadow",
      "targetEnd":   "shadow",
      "horizonBlendStart": 1.0,
      "horizonBlendEnd": 1.0,
    ...
    },
    {
      ...
      "camStart": { "lat": 26.0, "lng": 14.0, "radius": 75.0 },
      "camEnd":   { "lat": 22.0, "lng": 28.0, "radius": 82.0 },
      "targetStart": "shadow",
      "targetEnd":   "sun",
      "horizonBlendStart": 1.0,
      "horizonBlendEnd": 1.0,
    ...
    },
    {
      ...
      "camStart": { "lat": 22.0, "lng": 28.0, "radius": 82.0 },
      "camEnd":   { "lat": 18.0, "lng": 44.0, "radius": 140.0 },
      "targetStart": "sun",
      "targetEnd":   "sun",
      "horizonBlendStart": 1.0,
      "horizonBlendEnd": 0.0,
    ...
    },
    {
      ...
      "camStart": { "lat": 18.0, "lng": 44.0, "radius": 140.0 },
